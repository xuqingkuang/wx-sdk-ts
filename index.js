!(function(a, b) {
  ...
  function g(a) {
    return (a.postalCode =
      a.addressPostalCode), delete a.addressPostalCode, (a.provinceName = a.proviceFirstStageName), delete a.proviceFirstStageName, (a.cityName = a.addressCitySecondStageName), delete a.addressCitySecondStageName, (a.countryName = a.addressCountiesThirdStageName), delete a.addressCountiesThirdStageName, (a.detailInfo = a.addressDetailInfo), delete a.addressDetailInfo, a;
  }
  function h(a, b, c) {
    "openEnterpriseChat" == a &&
      (b.errCode =
        b.err_code), delete b.err_code, delete b.err_desc, delete b.err_detail;
    var d = b.errMsg;
    d ||
      ((d = b.err_msg), delete b.err_msg, (d = i(
        a,
        d
      )), (b.errMsg = d)), (c = c || {}), c._complete && (c._complete(b), delete c._complete), (d = b.errMsg || ""), D.debug && !c.isInnerInvoke && alert(JSON.stringify(b));
  ...
  function i(a, b) {
    ...
    if (b) {
      ...
      (e = b.substring(f + 1)), "confirm" == e && (e = "ok"), "failed" == e &&
        ...
        e.indexOf("fail_") && (e = e.substring(5)), (e = e.replace(
        /_/g,
        " "
      )), (e = e.toLowerCase()), ("access denied" == e ||
        "no permission to execute" == e) &&
        (e = "permission denied"), "config" == c &&
        "function not exist" == e &&
        (e = "ok"), "" == e && (e = "fail");
    }
    return (b = c + ":" + e);
  }
  ...
  function l(a) {
    if (!(v || w || D.debug || "6.0.2" > A || C.systemType < 0)) {
      ...
      (C.appId = D.appId), (C.initTime =
        B.initEndTime - B.initStartTime), (C.preVerifyTime =
